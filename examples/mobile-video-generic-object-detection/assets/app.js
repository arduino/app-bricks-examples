...
function updateDisplay() {
    ...
    if (webcamState.status == "streaming") {
        ...
        dynamicIframe.height = `${Math.max(722, Math.min(window.innerHeight - 223, (window.innerWidth - 60) * 4/3 + 20))}px`;
        dynamicIframe.width = `${Math.min(768, (window.innerWidth - 60))}px`;

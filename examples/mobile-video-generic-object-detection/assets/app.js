...
ui.on_message('detection', onDetection);
ui.on_message('welcome', onWelcome);
ui.on_message('connected', onConnected);
...
async function onDetection(message) {
...
async function onConnected(message) {
...
function renderDetections() {
  ...
  scans.forEach((scan) => {
    ...
    const parts = new Intl.DateTimeFormat('en-GB', options)
      .formatToParts(new Date(scan.timestamp))

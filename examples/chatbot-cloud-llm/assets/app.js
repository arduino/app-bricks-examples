...
document
  ...
  .addEventListener('click', () =>
    sendMessage(
      document.getElementById('card-1').querySelector('p').textContent,
    ),
  );
document
  ...
  .addEventListener('click', () =>
    sendMessage(
      document.getElementById('card-2').querySelector('p').textContent,
    ),
  );
document
  ...
  .addEventListener('click', () =>
    sendMessage(
      document.getElementById('card-3').querySelector('p').textContent,
    ),
  );
document
  ...
  .addEventListener('click', () =>
    sendMessage(
      document.getElementById('card-4').querySelector('p').textContent,
    ),
  );

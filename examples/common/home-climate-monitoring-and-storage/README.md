...
The **Home Climate Monitoring** example records temperature & humidity data from the [Arduino Modulino® Thermo](https://store.arduino.cc/products/modulino-thermo) node, and streams it to a web interface.
...
5. View the data from the Modulino Thermo in real time!
...
The data is recorded from a Modulino Thermo, connected to the board's Qwiic port, and sent to the Linux side using the **Bridge** tool.

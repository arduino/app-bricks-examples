...
Examples can only be viewed in Arduino App Lab when connected to a board. However, the documentation and source files can be accessed in the public [app-bricks-examples](https://github.com/arduino/app-bricks-examples) repository, organized in three folders:

- [inspirational](https://github.com/arduino/app-bricks-examples/tree/main/inspirational): complete Apps that showcase what you can build, listed in the table below. Examples that work on every board are in the `common` subfolder, board-specific ones in the `platform_unoq` and `platform_ventunoq` subfolders.
- [core-and-foundational](https://github.com/arduino/app-bricks-examples/tree/main/core-and-foundational): short examples that teach one building block at a time, from blinking an LED to computer vision.
- [bricks](https://github.com/arduino/app-bricks-examples/tree/main/bricks): minimal usage examples for each Brick.
...
| Color your LEDs | Control the color of your LEDs from a web interface. | [GitHub (UNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_unoq/color-your-leds) |
...
| Detect Objects on Camera | This example showcases object detection within a live feed from a camera. | [GitHub](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/common/video-generic-object-detection) |
...
| Edge AI Assistant | Chatbot powered by a local LLM | [GitHub (UNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_unoq/edge-ai-assistant) · [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/edge-ai-assistant) |
| Edge Dictation Assistant | A simple dictation assistant that converts your speech to text and displays it on a UI. | [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/edge-dictation-assistant) |
| Edge Speech Assistant | A text-to-speech assistant that converts text input into spoken audio. | [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/edge-speech-assistant) |
| Face Detector on Camera | This example showcases face detection within a live feed from a camera. | [GitHub (UNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_unoq/video-face-detection) · [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/video-face-detection) |
| Gesture Booth | Detects gesture and provide feedback to the user. | [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/gesture-booth) |
...
| Person Classifier on Camera | This example showcases person classification on camera, using a camera stream | [GitHub](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/common/video-person-classification) |
| Pose Detection | Match all the poses in front of the camera to win the game | [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/pose-detection) |
...
| Smart Mirror | Control a smart mirror with a web interface | [GitHub (VENTUNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_ventunoq/smart-mirror) |
...
| UNO Q Pin Toggle | Control each Arduino UNO Q pin through a visual UI | [GitHub (UNO Q)](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/platform_unoq/unoq-pin-toggle) |
...
| Visualize Smartphone Sensors | This example visualizes live sensor data streamed from a smartphone in an interactive web dashboard. | [GitHub](https://github.com/arduino/app-bricks-examples/tree/main/inspirational/common/mobile-remote-sensor) |
